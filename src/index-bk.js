...
import {Vote,VoteItem} from './components/vote/index.js';
    ...
    const components=[
       ActionSheet,   ActionSheetItem,   AssetsImg,   MAvatar,   MBadge,   MBlockquto,   MButtonGroup,   MButton,   MChatRoom,   ChatsBox,   ErrorBlock,   MFooter,   Guide,   MHeader,   HtmlBox,   MIcon,   MImageSelector,   MImage,   MInput,   MListItem,   Loading,   MModal,   MOperation,   MScroller,   MScrollerMenu,   Tab,   TabItem,   MTag,   MTitle,   MView,   Vote,   VoteItem
    ]
    const directives=[
        nativeDatePick
    ]
